...
const EXP = [
  ...
  },
  {
    ...
    color: '#818cf8',
    project: null,
    summary: 'Managed financial operations, budgeting, reporting, and compliance as CFO, ensuring smooth branch performance and supporting decision-making through accurate financial analysis.',
    resp: [
      'Managed day-to-day financial operations and branch budgeting.',
      'Prepared accurate financial reports and compliance documentation.',
      'Supported executive decision-making through detailed financial analysis.',
      'Ensured regulatory compliance and smooth branch performance.',
    ],
    tech: ['Financial Management', 'Financial Reporting', 'Financial Analysis', 'Cost Control', 'Cash Flow Management', 'Banking Operations'],
  },
]
